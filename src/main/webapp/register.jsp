                  ...
                  <div class="card-content">
                    <div class="card-body pt-0">
                      <form action="index"  method="post">
                        ...
                        <div class="form-label-group">
                          <input type="text" id="inputNum"  class="form-control" name="num" placeholder="Phone number" required>
                        ...
                        <div class="form-label-group">
                          <input type="password" id="inputConfPassword" name="cpassword" class="form-control" placeholder="Confirm Password" required>
                        ...
                        <a href="${pageContext.request.contextPath}/index" class="btn btn-outline-primary float-left btn-inline mb-50">Login</a>
